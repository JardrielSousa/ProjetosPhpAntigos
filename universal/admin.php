                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse" id="navigation">
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown active"><a href="admin.php"> Home <!--<b class="caret"></b>--></a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9" id="customer-orders">
						<h4> LISTA DE CONTATOS </h4></p>
                        <div class="box">
<div class="table-responsive">
<?php
include('conexaoBD.php');
$res = mysql_query('SELECT * FROM contato');
echo '<table class="table table-hover"><thead><tr><th> ID </th><thx> NOME </th><th> E-MAIL </th><th> MENSAGEM </th><th> DELETAR DADOS </th></tr>';
//	ENQUANDO HOUVER DADOS NA TABELA PARA SEREM MOSTRADOS SERÁ EXECUTADO TUDO QUE ESTA DE DENTRO DO WHILE
while($escrever=mysql_fetch_array($res)){
//	ESCREVE CADA LINHA DA TABELA
echo '<tbody><tr><th><span class="label label-info">' . $escrever['id'] . '</span></th><th>' . $escrever['nome'] . '</th><td><span class="label label-info">' . $escrever['email'] . '</span></td><td>' . $escrever['mensagem'] . '<td></td>' . '<td>
...
if(isset($_POST['id'])){
$id = $_POST['id'];
$deletarDados = mysql_query("DELETE FROM contato WHERE id='$id'");
}else if(isset($_POST['id'])){
echo 'Não foi possível exluir dados...';
}

//	ESSE CÓDIGO IRÁ ALTERAR OS DADOS ESCOLHIDOS PELO ADMIN
if(isset($_POST['atual']) && isset($_POST['alterado'])){
$atual = $_POST['atual'];
$alterado = $_POST['alterado'];
$alterarDados = mysql_query("UPDATE FROM contato id='$atual' WHERE id='$alterado'");
}else if(isset($_POST['atual']) && isset($_POST['alterado'])){
echo 'Não foi possível alterar dados...';
}
                        ...
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="active"><a href="admin.php"><i class="fa fa-list"></i> Vê Contatos </a></li>
         ...
         <div id="copyright">
            <div class="container">
                <div class="col-md-12">
                    ...
                    <p class="pull-right"> Link <a href="" title="Site"> QUIZ & TESTES </a>  | Email: <a href="" title="Email"> hello@universal.com </a></p>
                </div>
            </div>
        </div>
        <!-- /#copyright -->
